jajajaconst lenguaje = () => { return 'es' } //Español 
...
const smsLista7 = () => { return `⚜️ INSTALAR WITTYBOT ⚜️`}
...
//_allantilink.js
const smsTextoYT = () => { return '𝗪𝗶𝘁𝘁𝘆 - 𝗕𝗼𝘁'} 
...
const eWittyCoins = () => { return '💸 WittyCoins' }
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝗪𝗶𝘁𝘁𝘆-𝗕𝗼𝘁!!! \n\n💖 𝗪𝗶𝘁𝘁𝘆-𝗕𝗼𝘁 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝙊 𝙋𝙊𝙍:\n@${user}`}
...
smsJBCerrarS, smsJBErr, smsConj, smsFras, smsContacto1, smsContacto2, smsContacto3, smsContacto4,
